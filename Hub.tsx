...
const GAMES: Game[] = [
  ...
  },
  {
    id: 'battlefields',
    name: 'Battlefields',
    description: 'Tactical combat simulation. Command your forces and claim victory.',
    path: '#/battlefields',
    ...
    id: 'word-wheel',
    name: 'Word Wheel',
    description: 'Connect letters in a continuous line to form words. Guess the right words and they’ll fill in the crossword grid. Solve each word to complete the level!',
    path: '#/word-wheel',
    icon: <Grid className="w-5 h-5 text-white" />,
    thumbnail: images.wordwheel,
    scoreKey: 'word_wheel_highscore'
  },
  // {
   // id: 'game-2048',
   // name: '2048',
